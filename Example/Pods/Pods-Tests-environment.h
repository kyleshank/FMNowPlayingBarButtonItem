...
#define COCOAPODS_POD_AVAILABLE_FMNowPlayingBarButtonItem
#define COCOAPODS_VERSION_MAJOR_FMNowPlayingBarButtonItem 0
#define COCOAPODS_VERSION_MINOR_FMNowPlayingBarButtonItem 1
#define COCOAPODS_VERSION_PATCH_FMNowPlayingBarButtonItem 0
